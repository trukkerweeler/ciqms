' NCM Customer Dropdown - Active Customers from Global CUSTOMER_MASTER
' Returns CUSTOMER and NAME_CUSTOMER for records where REC = 1
...
If conn.State = 1 Then
    ...
    ' REC = 1 is the primary/valid record for a customer in this poorly designed table
    Dim sqlQuery
    sqlQuery = "SELECT CUSTOMER, NAME_CUSTOMER " & _
...
Function RecordsetToJSON(rs)
    ...
    Do Until rs.EOF
        ...
        For Each field In rs.Fields
            ...
            Else
                ' Pervasive CHAR fields are fixed-width and padded with trailing spaces
                If VarType(fieldValue) = vbString Then fieldValue = Trim(fieldValue)

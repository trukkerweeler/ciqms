' materialcert-coc.vbs
' Implements Steps 1-3 of MaterialCert Chain-of-Custody extraction
' Designed for use by materialcert.html frontend
'
...
'
' Usage: cscript //Nologo materialcert-coc.vbs <JOB> [SUFFIX] [selectedTransactionIndices]
' Example: cscript //Nologo materialcert-coc.vbs 122166 "" 0,1,3
'
...
If WScript.Arguments.Count > 0 Then
  ...
  End If
Else
  WScript.Echo "Usage: materialcert-coc.vbs <JOB> [SUFFIX] [selectedTransactionIndices]"
  WScript.Quit 1
End If

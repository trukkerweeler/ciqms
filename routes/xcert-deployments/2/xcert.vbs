...
' xcert.vbs - Query DB for xcert endpoint, patterned after certpass.vbs
' Usage: cscript //Nologo xcert.vbs <baseWorkorder> <suffix> <operationCodes>
...
Else
  ...
  Else
    MsgBox "Usage: xcert.vbs <baseWorkorder> <suffix> <operationCodes>"
    WScript.Quit
  End If
End If

// ctareportweld.js
import { loadHeaderFooter, myport, displayDate } from "./utils.mjs";
// loadHeaderFooter();
...
createFilterInput((filterValue) => {
    const filteredData = originalData.filter(row =>
        row.PEOPLE_ID && row.PEOPLE_ID.toString().includes(filterValue)
    );
...
const url = `http://localhost:${port}/reports/weld`;
